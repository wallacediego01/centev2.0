...
<section id="vitrine" class="_vitrine position-relative">
    ...
    <img src='<?=Utils::get_image_asset( 'elemento-corte.svg' ) ; ?>' alt='<?= ""; ?>' width='<?= ""; ?>' height='<?="" ; ?>' class='lozad corte'> 

    <div class="actions">
        <div class='container'>
            <div class='row'>
                <div class='col-12 mb-4'>
                    <div class="swiper-pagination-vitrine swiper-pagination"></div>
                </div>
                <div class="col-12">
                    <div class="ico-mouse mt-lg-6 mb-lg-6  d-lg-block d-none  text-left">
                        <a href="#post-serv">
